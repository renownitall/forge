...
The packages are built and published automatically and signed with _GNU Privacy Guard (GPG)_. They're hosted on GitHub Pages, and scheduled builds run daily at 04:37 UTC to pick up upstream changes for `-git` packages. If you run Arch Linux, you can install these packages with `pacman`.
